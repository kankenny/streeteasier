		...
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="">
			...
			<Card className="max-w-5xl h-fit max-h-fit mx-auto flex flex-col md:flex-row space-x-8 mt-0">
				<FormContainer>
					...
					<form noValidate className="flex flex-col mt-4 space-y-5" onSubmit={handleSubmit(processSignUp)}>
						<RHFTextField control={control} type="text" name="firstName" placeholder="First Name" />
						<RHFTextField control={control} type="text" name="lastName" placeholder="First Name" />
						<RHFDatePicker
							control={control}
							name="birthday"
